...
from applytex.config import COVER_LETTER_DIR, RESUME_PATH, load_profile
from applytex.database import get_connection, get_jobs_by_stage
from applytex.llm import get_client
from applytex.scoring.validator import (
    BANNED_WORDS,
    LLM_LEAK_PHRASES,
    sanitize_text,
...
def run_cover_letters(min_score: int = 7, limit: int = 0,
    ...
    for job in jobs:
        ...
        try:
            ...
            pdf_path = None
            try:
                from applytex.scoring.pdf import convert_to_pdf
