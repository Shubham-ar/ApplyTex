"""ApplyTex database layer: schema, migrations, stats, and connection helpers.
...
from applytex.config import get_db_path, DEFAULTS, pipeline_min_score
...
_ALL_COLUMNS: dict[str, str] = {
    ...
    "tailored_at": "TEXT",
    "tailor_attempts": "INTEGER DEFAULT 0",
    # LaTeX keyword match stage
    "tailored_latex_path": "TEXT",
    "latex_compile_error": "TEXT",
    "keyword_report_path": "TEXT",
    "review_status": "TEXT",
    "keyword_match_before": "REAL",
    "keyword_match_after": "REAL",
    # Cover letter
    "cover_letter_path": "TEXT",
    "cover_letter_at": "TEXT",
    "cover_attempts": "INTEGER DEFAULT 0",
...
def get_stats(conn: sqlite3.Connection | None = None) -> dict:
    ...
    stats["latex_ready"] = conn.execute(
        "SELECT COUNT(*) FROM jobs "
        "WHERE review_status = 'approved' "
        "AND tailored_latex_path IS NOT NULL"
    ).fetchone()[0]
...
def get_jobs_by_stage(conn: sqlite3.Connection | None = None,
    ...
    conditions = {
        ...
        "pending_latex": (
            "fit_score >= ? AND full_description IS NOT NULL "
            "AND keyword_report_path IS NULL AND COALESCE(tailor_attempts, 0) < 5"
        ),
        "pending_review": "review_status = 'pending' AND keyword_report_path IS NOT NULL",
    ...
    if "?" in where and min_score is not None:
        ...
        params.append(pipeline_min_score())
