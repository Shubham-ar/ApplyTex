...
from applytex.apply import chrome, dashboard, prompt as prompt_mod
from applytex.apply.chrome import (
    launch_chrome, cleanup_worker, kill_all_chrome,
    reset_worker_dir, cleanup_on_exit, _kill_process_tree,
    BASE_CDP_PORT,
)
from applytex.apply.dashboard import (
...
def _resolve_min_score(min_score: int | None) -> int:
    if min_score is not None:
        return min_score
    from applytex.config import pipeline_min_score
    return pipeline_min_score()


# Blocked sites loaded from config/sites.yaml
def _load_blocked():
    from applytex.config import load_blocked_sites
...
def acquire_job(target_url: str | None = None, min_score: int | None = None,
    ...
    try:
        ...
        from applytex.config import is_manual_ats
...
def gen_prompt(target_url: str, min_score: int | None = None,
...
def worker_loop(worker_id: int = 0, limit: int = 1,
                ...
                min_score: int | None = None, headless: bool = False,
